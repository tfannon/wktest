...
@interface SDataGridSectionHeaderStyle : SDataGridWrapper <NSCopying>
...
/** This property represents the gradient that will be applied to the section header(s). The gradient is applied over the background color. Setting this property to nil will remove the default gradient applied to the section headers. */
