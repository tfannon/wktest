...
- (NSUInteger)shinobiGrid:(ShinobiGrid *) grid numberOfRowsInSection:(NSInteger)  sectionIndex;
...
/** Asks the data source to return the number of sections that the ShinobiGrid object should have.
 ...
 @warning *Important* If 1 is returned in this method you MUST implement the SGridDelegate method 'shinobiGrid:styleForSectionHeaderAtIndex:' for that section to be displayed. The SGridDelegate method returns the SGridSectionHeaderStyle to be applied to your grid's only section header. If this method is not implemented your section header WILL NOT be displayed.
 ...
 */
- (NSString *)shinobiGrid:(ShinobiGrid *)grid titleForHeaderInSection:(NSInteger) section;
 ...
 */
- (NSString *)shinobiGrid:(ShinobiGrid *)grid titleForFrozenHeaderInSection:(NSInteger) section;
 ...
 */
- (UIView *)shinobiGrid:(ShinobiGrid *)grid viewForHeaderInSection:(NSInteger) section inFrame:(CGRect)frame;
...
/** Asks the data source for a view for the frozen portion of header of the specified section of the ShinobiGrid object.
 ...
 The frame parameter specifies the header's bounds, which you can use to size your view appropriately.
 */
- (UIView *)shinobiGrid:(ShinobiGrid *)grid viewForFrozenHeaderInSection:(NSInteger) section inFrame:(CGRect)frame;
